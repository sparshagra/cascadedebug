...
"""
FastAPI application for the Cascade Debug Environment.
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m cascade_debug.server.app
    ...
    multiple workers:
        uvicorn cascade_debug.server.app:app --workers 4
    """
    import uvicorn
